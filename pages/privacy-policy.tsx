...
const PrivacyPolicyPage: NextPage = () => {
  return (
    <MainLayout className='text-2xl prose mx-auto !max-w-4xl'>
      ...
      <p>
        A sua privacidade é importante para nós. É política do broas respeitar a
        sua privacidade em relação a qualquer informação sua que possamos
        coletar no site
        <a href='https://broas.vercel.app'>broas</a>, e outros sites que
      ...
      <h2>Política de Cookies broas</h2> <h3>O que são cookies?</h3>{" "}
      <p>
      ...
      <p>
        ...
        informação que o broas oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>{" "}
      <ul>
        {" "}
        ...
        <li>
          ...
          xenofóbica,
          <a href='https://jogoshoje.io'>jogos de hoje</a> ou azar, qualquer
          tipo de pornografia ilegal, de apologia ao terrorismo ou contra os
          direitos humanos;
        </li>{" "}
        <li>
          C) Não causar danos aos sistemas físicos (hardwares) e lógicos
          (softwares) do broas, de seus fornecedores ou terceiros, para
